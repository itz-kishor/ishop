...
module.exports = __webpack_require__("ZLPb");
...
const createCategory = async (req, res) => {
  try {
    ...
    const newCategory = new _models_categoriesModel__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]({
      name
    });
...
const getCategories = async (req, res) => {
  try {
    const categories = await _models_categoriesModel__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].find();
    res.json({
      categories
    });
  } catch (err) {

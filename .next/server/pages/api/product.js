...
module.exports = __webpack_require__("ssDe");
...
const getProducts = async (req, res) => {
  try {
    const features = new APIfeatures(_models_productModel__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].find(), req.query).filtering().sorting().paginating();
...
const createProduct = async (req, res) => {
  try {
    ...
    const newProduct = new _models_productModel__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]({

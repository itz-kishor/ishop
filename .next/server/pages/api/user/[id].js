...
const updateRole = async (req, res) => {
  try {
    ...
    await _models_userModel__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].findOneAndUpdate({
      _id: id
    }, {
      role
    });
...
const deleteUser = async (req, res) => {
  try {
    ...
    await _models_userModel__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].findByIdAndDelete(id);
    res.json({
      msg: 'Deleted Success!'
    });
  } catch (err) {
